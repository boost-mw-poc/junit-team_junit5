...
public class JUnitException extends RuntimeException {
	...
	public JUnitException(String message, @Nullable Throwable cause) {
		super(message, cause);
	}
	...
	protected JUnitException(String message, @Nullable Throwable cause, boolean enableSuppression,
